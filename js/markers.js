...
var objMarkers = {
  ...
  initMarker: function (station) {
    ...
    if (sessionStorage.length != 0) {
      $ ('#ligneStation').text (
        'Vous avez réservé un vélo à la station : ' + donneesSessionName
      );
      $ ('#ligneAdresse').text (
        "située à l'adresse : " + donneesSessionAddress
      );
      ...
      $ ('#ligneAdresse').text (
        'Sélectionnez une station afin de réserver un vélo'
      );
    }
    ...
    marker.addListener ('click', function () {
      ...
      $ ('.buttonReservation').click (function () {
        ...
        $ ('#ligneStation').text (
          'Vous avez réservé un vélo à la station : ' + station.name
        );
